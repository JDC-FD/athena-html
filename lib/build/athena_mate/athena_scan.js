...
var ViewHelper = {
  ...
  widget: {
    ...
    load: function (widgetName, param, moduleName) {
      ...
      if(util.existsSync(widgetJsonPath)){
        var widgetJsonData = require(widgetJsonPath).data;
      }
      var widgetConfigData = widgetJsonData ? widgetJsonData : {};
      param = param ? param : widgetConfigData;
